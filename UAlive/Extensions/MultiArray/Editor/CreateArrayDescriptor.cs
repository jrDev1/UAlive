...
namespace Lasm.UAlive
{
    ...
    public class CreateMultiArrayDescriptor : UnitDescriptor<CreateMultiArray>
    {
        ...
        {
            if (icon == null) icon = AssetDatabase.LoadAssetAtPath<Texture2D>(RootPathFinder.rootPath + "UAlive/Extensions/MultiArray/Editor/Resources/Lasm.BoltExtensions.GetArrayItem@32x.png");
