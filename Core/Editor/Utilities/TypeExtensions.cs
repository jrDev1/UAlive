...
namespace Lasm.UAlive
{
    public static class TypeExtensions
    {
        ...
        public static ClassDefiner Definer(this CustomClass defined)
        {
            return ClassDefiner.GetDecorator(defined) as ClassDefiner;
        }

        public static MethodDefiner Definer(this Methods defined)
        {
            return MethodDefiner.GetDecorator(defined) as MethodDefiner;
        }
    }
}
